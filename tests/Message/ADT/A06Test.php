...
final class A06Test extends TestCase
{
     ...
     */
    private function parse(array $beforePv1 = [], array $afterPv1 = []): A06
    {
        $lines = ['MSH|^~\\&', 'EVN|A06', 'PID|1', ...$beforePv1, 'PV1|1', ...$afterPv1];
    ...
    public function testGetPv2ReturnsThePatientVisitAdditionalInformationSegment(): void
    {
        ...
        $message = new A06();
        $message->parse($this->encoding, "MSH|^~\\&\rEVN|A06\rPID|1\rPV1|1\rPV2|1");
    ...
    public function testGetDrgReturnsTheDiagnosisRelatedGroupSegment(): void
    {
        ...
        $message = new A06();
        $message->parse($this->encoding, "MSH|^~\\&\rEVN|A06\rPID|1\rPV1|1\rDRG|1");
